...
class ContactusControllerTest < ActionController::TestCase
  ...
  test "should create contactu" do
    assert_difference('Contactu.count') do
      post :create, contactu: { address: @contactu.address, cell: @contactu.cell, email: @contactu.email, name: @contactu.name }
    end
  ...
  test "should update contactu" do
    patch :update, id: @contactu, contactu: { address: @contactu.address, cell: @contactu.cell, email: @contactu.email, name: @contactu.name }
    assert_redirected_to contactu_path(assigns(:contactu))
  end
